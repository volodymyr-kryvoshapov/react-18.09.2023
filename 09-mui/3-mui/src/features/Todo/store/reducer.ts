...
export const todoSlice = createSlice({
  ...
  reducers: {
    ...
    getListActionRequest: (state: TodoStateI) => {
    ...
    // removeItemRequest: (state: TodoStateI, action: PayloadAction<number, any, any>) => {},
...
export const removeItemRequestType = `${todoSlice.name}/removeItemRequest`
